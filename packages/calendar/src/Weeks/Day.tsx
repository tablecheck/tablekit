...
function getTabIndex(
  calendars: ReturnType<typeof useCalendarContext>['calendars'],
  date: DateObj,
  selected: ReturnType<typeof useCalendarContext>['selected'],
  hoveredDate: ReturnType<typeof useCalendarContext>['hoveredDate'],
...
export function useDayProps(
  ...
  if (!isSelectable) dateState = DayState.Disabled;
  else if (isSelected) {
...
export function Day({ dateObj }: { dateObj: DateObj }): JSX.Element {
  const props = useDayProps(dateObj);
